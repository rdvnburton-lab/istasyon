...
export class IstasyonYonetimiComponent implements OnInit {
    ...
    apiKey: string = '';
    istasyonKodu: string = '';
    otomasyonFiloKodu: string = 'C0000';
    ...
    showIstasyonDialog(editMode: boolean, data?: any, firmaId?: number) {
        ...
        if (editMode && data) {
            ...
            this.istasyonKodu = data.istasyonKodu || '';
            this.otomasyonFiloKodu = data.otomasyonFiloKodu || 'C0000';
            this.otomatikDosyaYolu = data.otomatikDosyaYolu || '';
            this.isActive = data.aktif;
        } else {
            ...
            this.apiKey = '';
            this.istasyonKodu = '';
            this.otomasyonFiloKodu = 'C0000';
            this.otomatikDosyaYolu = '';
            this.isActive = true;
        }
    ...
    saveIstasyon() {
        if (this.isEditMode) {
            const dto: UpdateIstasyonDto = {
                ...
                apiKey: this.apiKey,
                istasyonKodu: this.istasyonKodu,
                otomasyonFiloKodu: this.otomasyonFiloKodu,
                otomatikDosyaYolu: this.otomatikDosyaYolu
            };
