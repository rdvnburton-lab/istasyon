...
@Component({
    ...
    template: `
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        ...
                        <div class="flex gap-2 flex-wrap items-center">
                            ...
                            <div class="flex items-center gap-2 px-4 py-2 rounded-lg mr-2"
                                ...
                                <i class="pi" [ngClass]="mutabakatTamamlandi ? 'pi-check-circle' : 'pi-clock'" style="color: white;"></i>
                            ...
                            <p-button 
                                ...
                                severity="info"
                                (onClick)="farkAnaliziYap()">
                            </p-button>
                            <p-button 
                                label="Onaya Gönder" 
                                icon="pi pi-send" 
                                severity="success"
                                [disabled]="!mutabakatTamamlandi"
                                (onClick)="onayaGonder()">
                            </p-button>
                            <p-button 
                                label="Geri" 
                ...
                <div class="p-4 rounded-xl h-full transition-all duration-300 hover:scale-105"
                    ...
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <div class="text-right">
                            <span class="text-xs uppercase tracking-wider" style="color: rgba(255,255,255,0.7);">Otomasyon</span>
                        ...
                        <ng-template pTemplate="body" let-personel>
                            <tr [ngClass]="{
                                ...
                                <td class="text-right font-bold" 
                                    ...
                                    {{ getPusulaFark(personel.personelId, personel.toplamTutar) | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}
                                </td>
                                <td>
                                    <p-button 
                                        icon="pi pi-pencil" 
                                        ...
                                        (onClick)="personelSec(personel)"
                                        pTooltip="Pusula Girişi"
                ...
                <div class="card h-full">
                    ...
                    <div class="mb-4 p-4 bg-surface-50 dark:bg-surface-800 rounded-lg">
                        <div class="grid grid-cols-12 gap-4">
                            <div class="col-span-12">
                                <div *ngIf="!seciliPersonel" class="flex flex-col items-center justify-center p-8 text-surface-500 border-2 border-dashed border-surface-300 dark:border-surface-700 rounded-lg">
                                ...
                                <div *ngIf="seciliPersonel" class="flex items-center justify-between bg-white dark:bg-surface-900 p-3 rounded-lg border border-blue-200 dark:border-blue-900/50 mb-4">
                                    ...
                                    <p-button 
                                        ...
                                        [text]="true" 
                                        severity="secondary" 
                                        (onClick)="seciliPersonel = null"
                                        pTooltip="Seçimi Kaldır">
                                    </p-button>
                                </div>
                            </div>
                            ...
                            <ng-container *ngIf="seciliPersonel">
                                ...
                                <div class="col-span-6 md:col-span-3">
                                    <div class="flex justify-between items-center mb-2">
                                        ...
                                        <p-button 
                                            ...
                                            [text]="true" 
                                            severity="info"
                                            styleClass="!p-0 !h-auto !py-0"
                                            (onClick)="krediKartiDialogAc()">
                                        </p-button>
                                    </div>
                                    <p-inputnumber 
                                        [(ngModel)]="pusulaForm.krediKarti" 
                                        mode="currency" 
                                        currency="TRY" 
                                        locale="tr-TR"
                                        [readonly]="true"
                                        styleClass="w-full"
                                        placeholder="Detaylardan giriniz"
                                        (click)="krediKartiDialogAc()">
                                    </p-inputnumber>
                                </div>
                                <div class="col-span-6 md:col-span-3">
                                    <label class="font-semibold text-sm mb-2 block text-yellow-600">Veresiye</label>
                                    <p-inputnumber 
                                        [(ngModel)]="pusulaForm.veresiye" 
                                        mode="currency" 
                                        currency="TRY" 
                                        locale="tr-TR"
                                        styleClass="w-full">
                                ...
                                <div class="col-span-6 md:col-span-3">
                                    <label class="font-semibold text-sm mb-2 block text-purple-600">Filo Kartı</label>
                                    <p-inputnumber 
                                        [(ngModel)]="pusulaForm.filoKarti" 
                                        mode="currency" 
                                        currency="TRY" 
                                        locale="tr-TR"
                                        styleClass="w-full">
                                ...
                                <div class="col-span-12 flex justify-between items-center">
                                    <div>
                                        ...
                                        <span class="font-bold text-lg ml-2">{{ getPusulaFormToplam() | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</span>
                    ...
                    <p-table [value]="pusulalar" styleClass="p-datatable-sm" *ngIf="!seciliPersonel">
                        <ng-template pTemplate="header">
                            <tr>
                                ...
                                <th class="text-right">Veresiye</th>
                        ...
                        <ng-template pTemplate="body" let-pusula>
                            <tr>
                                ...
                                <td class="text-right text-green-600">{{ pusula.nakit | currency:'TRY':'symbol-narrow':'1.0-0':'tr' }}</td>
                                <td class="text-right text-blue-600">{{ pusula.krediKarti | currency:'TRY':'symbol-narrow':'1.0-0':'tr' }}</td>
                                <td class="text-right text-yellow-600">{{ pusula.veresiye | currency:'TRY':'symbol-narrow':'1.0-0':'tr' }}</td>
                                <td class="text-right font-bold">{{ pusula.toplam | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</td>
                                <td>
                                    <p-button 
                                        icon="pi pi-trash" 
                                        severity="danger" 
                    ...
                    <div *ngIf="seciliPersonel" class="mt-4">
                        <div class="p-4 border rounded-xl bg-surface-0 dark:bg-surface-900 shadow-sm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <!-- Genel Döküm -->
                                <div>
                                    <span class="text-sm text-surface-500 block mb-2 font-semibold uppercase tracking-wider">Genel Döküm</span>
                                    <ul class="p-0 m-0 list-none">
                                        <li class="flex justify-between py-2 border-b border-surface-200 dark:border-surface-700">
                                            <span class="text-surface-600 dark:text-surface-400">Nakit</span>
                                            <span class="font-bold text-green-600">{{ pusulaForm.nakit | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</span>
                                        </li>
                                        <li class="flex justify-between py-2 border-b border-surface-200 dark:border-surface-700">
                                            <span class="text-surface-600 dark:text-surface-400">Kredi Kartı</span>
                                            <span class="font-bold text-blue-600">{{ pusulaForm.krediKarti | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</span>
                                        </li>
                                        <li class="flex justify-between py-2 border-b border-surface-200 dark:border-surface-700">
                                            <span class="text-surface-600 dark:text-surface-400">Veresiye</span>
                                            <span class="font-bold text-yellow-600">{{ pusulaForm.veresiye | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</span>
                                        </li>
                                        <li class="flex justify-between py-2 border-b border-surface-200 dark:border-surface-700">
                                            <span class="text-surface-600 dark:text-surface-400">Filo Kartı</span>
                                            <span class="font-bold text-purple-600">{{ pusulaForm.filoKarti | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</span>
                                        </li>
                                        <li class="flex justify-between py-2 mt-2 bg-surface-50 dark:bg-surface-800 rounded px-2">
                                            <span class="font-bold text-surface-900 dark:text-surface-0">TOPLAM</span>
                                            <span class="font-bold text-lg text-surface-900 dark:text-surface-0">{{ getPusulaFormToplam() | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    <span class="text-sm text-surface-500 block mb-2 font-semibold uppercase tracking-wider">Kredi Kartı Detayları</span>
                                    
                                    <div *ngIf="!pusulaForm.krediKartiDetay?.length" class="text-center p-4 bg-surface-50 dark:bg-surface-800 rounded-lg text-surface-500 text-sm">
                                        Banka detayı girilmemiş
                                    </div>

                                    <div *ngIf="pusulaForm.krediKartiDetay?.length" class="border border-surface-200 dark:border-surface-700 rounded-lg overflow-hidden">
                                        <div *ngFor="let detay of pusulaForm.krediKartiDetay" class="flex justify-between items-center p-2 border-b border-surface-200 dark:border-surface-700 last:border-0 hover:bg-surface-50 dark:hover:bg-surface-800">
                                            <span class="text-sm font-medium">{{ detay.banka }}</span>
                                            <span class="text-sm font-bold text-blue-600">{{ detay.tutar | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</span>
                                        </div>
                                        <div class="flex justify-between items-center p-2 bg-blue-50 dark:bg-blue-900/20 font-bold text-sm">
                                            <span>Toplam</span>
                                            <span class="text-blue-600">{{ pusulaForm.krediKarti | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <p-table [value]="farkAnalizleri" styleClass="p-datatable-striped">
                        ...
                        <ng-template pTemplate="body" let-analiz>
                            <tr>
                                ...
                                <td class="text-right">{{ analiz.otomasyonToplam | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</td>
                                <td class="text-right">{{ analiz.pusulaToplam | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</td>
                                ...
                                <td class="text-center">
                                    <p-tag 
                                        [value]="getFarkDurumLabel(analiz.farkDurum)" 
                                ...
                                <td>
                                    <div class="flex gap-2 text-xs">
                                        ...
                                        <span class="text-blue-600">K: {{ analiz.pusulaDokum.krediKarti | number:'1.0-0' }}</span>
                                        <span class="text-yellow-600">V: {{ analiz.pusulaDokum.veresiye | number:'1.0-0' }}</span>
                                    </div>
                                </td>
                            </tr>
                        </ng-template>
                    ...
                    <div class="flex flex-wrap gap-3">
                        <div *ngFor="let gider of giderler" 
                            ...
                            <div>
                                ...
                                <p class="text-orange-600 font-bold m-0">{{ gider.tutar | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</p>
                            </div>
                            <p-button 
                                icon="pi pi-trash" 
                                severity="danger" 
        ...
        <p-dialog 
            header="Kredi Kartı Detayları" 
            [(visible)]="krediKartiDialogVisible" 
            [modal]="true"
            [style]="{width: '450px'}">
            ...
            <div class="flex flex-col gap-4">
                <div class="flex gap-2 items-end">
                    ...
                    <p-button icon="pi pi-plus" (onClick)="krediKartiEkle()" [disabled]="!yeniKrediKarti.banka || !yeniKrediKarti.tutar"></p-button>
                </div>

                <div class="border rounded-lg overflow-hidden">
                    <div *ngFor="let detay of anlikKrediKartiDetaylari; let i = index" class="flex justify-between items-center p-3 border-b last:border-0 hover:bg-surface-50 dark:hover:bg-surface-800">
                        <span class="font-semibold">{{ detay.banka }}</span>
                        <div class="flex items-center gap-3">
                            <span class="font-bold text-blue-600">{{ detay.tutar | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</span>
                ...
                <div class="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg font-bold">
                    <span>TOPLAM</span>
                    <span class="text-blue-600">{{ getAnlikKrediKartiToplam() | currency:'TRY':'symbol-narrow':'1.2-2':'tr' }}</span>
                </div>
            </div>
    ...
    styles: [`
        :host { display: block; }
        :host ::ng-deep .row-completed { background-color: #dcfce7 !important; }
        :host ::ng-deep .row-selected { background-color: #dbeafe !important; }
        :host ::ng-deep .dark .row-completed { background-color: rgba(20, 83, 45, 0.3) !important; }
        :host ::ng-deep .dark .row-selected { background-color: rgba(30, 58, 138, 0.5) !important; }
    `]
})
